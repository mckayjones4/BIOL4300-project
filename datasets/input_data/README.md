...
| **`03.alignments/`**         | Cleaned and trimmed versions of the MAFFT alignments. Gaps and poorly aligned regions were filtered out using script `code/05.trim.R`. These files were inputs for both maximum likelihood and Bayesian tree inference.                                           |
